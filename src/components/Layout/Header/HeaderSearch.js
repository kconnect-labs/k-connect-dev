...
const StyledSearchInput = React.forwardRef(
  (
    {
      focused,
      placeholder,
    ...
    return (
      <div className='search-input-container'>
        {startAdornment && (
          <div className='search-input-start-adornment'>{startAdornment}</div>
        )}
        <input
          ref={ref}
          type='text'
        ...
        />
        {endAdornment && (
          <div className='search-input-end-adornment'>{endAdornment}</div>
        )}
      </div>
    );
  }
                  ...
                  <div className='search-results-list'>
                    {searchResults.users.map(user => (
                      <div
                        ...
                        onClick={() =>
                          handleSearchItemClick(`/profile/${user.username}`)
                        }
                      >
                ...
                <div className='search-results-list'>
                  {searchResults.channels.map(channel => (
                    <div
                      ...
                      className='search-result-item'
                      onClick={() =>
                        handleSearchItemClick(`/profile/${channel.username}`)
                      }
                    >
                      <div className='search-result-avatar'>
                        <img
