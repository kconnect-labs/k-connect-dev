        ...
        >
          ...
          <Box sx={{ display: 'flex', alignItems: 'flex-start', mb: 1 }}>
            ...
            <Box sx={{ flex: 1, position: 'relative' }}>
              ...
              {content.trim() && (content.includes('**') || content.includes('*') || content.includes('`') || content.includes('#') || content.includes('~~')) && (
                ...
                <Box sx={{ mt: 1 }}>
                  ...
                  >
                    <Box 
                      ...
                      onClick={() => {
                        const textarea = document.querySelector('.MuiInputBase-input');
                        if (textarea) {
                    ...
                    <Box 
                      ...
                      onClick={() => {
                        ...
                        if (textarea) {
                          const start = textarea.selectionStart;
                          const end = textarea.selectionEnd;
                          const selectedText = content.substring(start, end) || 'код';
                          const newContent = content.substring(0, start) + `\`${selectedText}\`` + content.substring(end);
                          setContent(newContent);
                          setTimeout(() => {
                            textarea.focus();
