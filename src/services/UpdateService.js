...
const updates = [
  {version: '3.1.0',
    ...
    updates: ['Выпущены ексклюзивные паки', 'Оптимизация', 'Мессенджер обновлен', 'Новые оверлеи','Увеличен лимит айтемов - оверлеи не считаются при подсчете количества айтемов','Оверлеи имеют отдельный тег'],
    fixes: ['Исправлены ошибки отображения', 'Исправлены ошибки в бекенде', 'Исправлены ошибки в фронтенде'],
  },
  {version: '3.1pre',
    date: '12.08.2025',
