...
const updates = [
  {
    ...
    updates: [
      'Обновлен полностью маркетплейс айтемов',
      'Возвращены фоны айтемов',
      'Карточки артисты могут редактировать сами артисты',
    ],
    fixes: [
      'Оптимизация',
      'Исправлена создание бейджиков',
      'Исправлены ошибки S3 хранилища',
    ],
  },
  {
    version: '3.1.5',
  ...
  },
  {
    ...
    updates: [
      'Новая прогрузка стикеров',
      'Оптимизация',
      'Мессенджер обновлен на новые темы',
      'Новые настройки',
    ],
    fixes: [
      'Исправлены стили на множественных страницах',
      'Исправлены стили на странице правил',
      'Исправлены стили на странице политики конфиденциальности',
    ],
  },
  {
    ...
    updates: [
      'Приватный профиль',
      'Оптимизация',
      'Новые темы: Midnight, Ocean, Sunset, Forest, Aurora, Cosmic, Neon, Vintage',
    ],
    fixes: [
      'Исправлены стили на множественных страницах',
      'Исправлены стили на странице правил',
