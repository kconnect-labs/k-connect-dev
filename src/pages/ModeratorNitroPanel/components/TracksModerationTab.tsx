...
const TracksModerationTab: React.FC = () => {
  ...
  const { getTracks, deleteTrack, clearTrackDescription, clearTrackLyrics } =
    useNitroApi();
  ...
  const [clearDescriptionDialogOpen, setClearDescriptionDialogOpen] =
    useState(false);
  ...
  return (
    <Box sx={{ p: 0 }}>
      ...
      >
        ...
        <DialogContent>
          <Typography>
            Вы уверены, что хотите удалить трек "{selectedTrack?.title}" от{' '}
      ...
      <Dialog
        open={clearDescriptionDialogOpen}
        onClose={() => setClearDescriptionDialogOpen(false)}
      >
        <DialogTitle>Очистить описание</DialogTitle>
        <DialogContent>
          <Typography>
            Вы уверены, что хотите очистить описание трека "
            {selectedTrack?.title}"?
          </Typography>
        </DialogContent>
        <DialogActions>
          <Button onClick={() => setClearDescriptionDialogOpen(false)}>
            Отмена
          </Button>
          <Button
            color='warning'
            ...
            startIcon={
              clearLoading ? <CircularProgress size={20} /> : <ClearIcon />
            }
          >
            Очистить
          </Button>
      ...
      >
        ...
        <DialogContent>
          <Typography>
            Вы уверены, что хотите очистить текст песни для трека "
            {selectedTrack?.title}"?
          </Typography>
        </DialogContent>
        <DialogActions>
          <Button onClick={() => setClearLyricsDialogOpen(false)}>
            Отмена
          </Button>
          <Button
            color='warning'
      ...
      >
        ...
        <DialogContent>
          <Typography variant='body2' color='text.secondary' sx={{ mb: 2 }}>
            Выберите действие для трека "{selectedTrack?.title}" от{' '}
            {selectedTrack?.artist}
          </Typography>
          <List>
        ...
        <DialogActions>
          <Button onClick={() => setActionsDialogOpen(false)}>Отмена</Button>
        </DialogActions>
      </Dialog>
    </Box>
  );
