...
const ModeratorsTab: React.FC = () => {
  ...
  const openModeratorDialog = (user: User) => {
    ...
    if (existingModerator) {
      setPermissions({
        ...
        change_user_name:
          existingModerator.permissions.change_user_name || false,
        change_username: existingModerator.permissions.change_username || false,
        manage_bug_reports:
          existingModerator.permissions.manage_bug_reports || false,
        delete_bug_reports:
          existingModerator.permissions.delete_bug_reports || false,
        ...
        can_generate_keys:
          existingModerator.permissions.can_generate_keys || false,
        verify_users: existingModerator.permissions.verify_users || false,
        assign_moderators:
          existingModerator.permissions.assign_moderators || false,
      });
    } else {
  ...
  const permissionGroups = [
    ...
    },
    {
      ...
      permissions: [
        {
          key: 'change_user_name',
          label: 'Изменение имени пользователя',
          icon: <Edit />,
        },
    ...
    },
    {
      ...
      permissions: [
        {
          key: 'manage_bug_reports',
          label: 'Управление баг-репортами',
          icon: <Security />,
        },
        {
          key: 'delete_bug_reports',
  ...
  return (
    <Box>
        ...
        >
          {moderators.map(moderator => (
            ...
            >
              <ListItemAvatar>
                <Avatar
                  src={moderator.avatar_url || undefined}
                  alt={moderator.name}
                >
                ...
                secondary={
                  <Box>
                    ...
                    >
                      ...
                      <Typography variant='caption' color='text.secondary'>
                        {
                          Object.values(moderator.permissions).filter(Boolean)
                            .length
                        }{' '}
                        прав
                      </Typography>
      ...
      >
        <DialogTitle sx={{ pb: 1 }}>Назначение модератора</DialogTitle>
                        ...
                        <FormControlLabel
                          control={
                            <Switch
                              checked={
                                permissions[
                                  permission.key as keyof ModeratorPermission
                                ] as boolean
                              }
                              onChange={() =>
