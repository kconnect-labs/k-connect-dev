...
const SubscriptionsTab: React.FC = () => {
  ...
  return (
    <Box>
          ...
          >
            <CardContent sx={{ textAlign: 'center', p: 2 }}>
              ...
              <Typography variant='h6' color='primary'>
                {availableSubscriptionTypes.find(st => st.id === 'basic')
                  ?.users_count || 0}
              </Typography>
            </CardContent>
          </Card>
          ...
          >
            <CardContent sx={{ textAlign: 'center', p: 2 }}>
              ...
              <Typography variant='h6' color='secondary'>
                {availableSubscriptionTypes.find(st => st.id === 'premium')
                  ?.users_count || 0}
              </Typography>
            </CardContent>
          </Card>
          ...
          >
            <CardContent sx={{ textAlign: 'center', p: 2 }}>
              ...
              <Typography variant='h6' color='warning.main'>
                {availableSubscriptionTypes.find(st => st.id === 'ultimate')
                  ?.users_count || 0}
              </Typography>
            </CardContent>
          </Card>
          ...
          >
            <CardContent sx={{ textAlign: 'center', p: 2 }}>
              ...
              <Typography variant='h6' color='error.main'>
                {availableSubscriptionTypes.find(st => st.id === 'max')
                  ?.users_count || 0}
              </Typography>
            </CardContent>
          </Card>
      ...
      >
        <DialogTitle sx={{ pb: 1 }}>Подписки пользователя</DialogTitle>
              ...
              {userSubscriptions.length > 0 ? (
                <List>
                  {userSubscriptions.map(subscription => {
                    const typeInfo = getSubscriptionTypeInfo(
                    ...
                    return (
                      ...
                      >
                        <ListItemAvatar>
                          <Avatar
                            sx={{
                              bgcolor: `${getSubscriptionColor(subscription.subscription_type)}.main`,
                            }}
                          >
                            {getSubscriptionIcon(
                              subscription.subscription_type
                          ...
                          primary={
                            ...
                            >
                              ...
                              <Chip
                                ...
                                color={
                                  subscription.is_active ? 'success' : 'error'
                                }
                                size='small'
                                variant='outlined'
                              />
                ...
                <Alert severity='info'>У пользователя пока нет подписок</Alert>
              )}
            </Box>
          )}
        </DialogContent>
