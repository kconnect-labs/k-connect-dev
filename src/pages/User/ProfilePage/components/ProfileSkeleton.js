    ...
    >
      ...
      >
                ...
                {Array.from({ length: 3 }).map((_, idx) => (
                  <Grid item xs={4} key={idx}>
                    <Skeleton
                      ...
                      height={60}
                      animation='wave'
                      sx={{ bgcolor: skeletonBgColor, borderRadius: '8px' }}
                    />
                  </Grid>
                ))}
              </Grid>
        ...
        <Grid item xs={12} lg={7}>
          {/* Таббар */}
          <Paper sx={{ borderRadius: '12px', mb: '5px', overflow: 'hidden', background: 'var(--theme-background, rgba(255,255,255,0.03))', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)' }}>
            <Box sx={{ display: 'flex' }}>
