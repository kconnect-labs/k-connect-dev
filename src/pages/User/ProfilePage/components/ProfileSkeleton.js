    ...
    >
      ...
      >
        ...
        <Grid item xs={12} lg={7}>
          {/* Таббар */}
          <Paper sx={{ borderRadius: 'var(--main-border-radius)', mb: '5px', overflow: 'hidden', boxShadow: 'var(--box-shadow)', background: 'var(--theme-background, rgba(255,255,255,0.03))', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)' }}>
            <Box sx={{ display: 'flex' }}>
