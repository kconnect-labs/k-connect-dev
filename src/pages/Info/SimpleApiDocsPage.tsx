...
const MethodChip = styled(Chip)<MethodChipProps>(({ theme, method }) => {
  ...
  return {
    backgroundColor:
      theme.palette.mode === 'dark' ? alpha(color.color, 0.2) : color.bg,
    color: color.color,
    fontWeight: 600,
    fontSize: '0.75rem',
    height: 24,
  ...
  return (
    <PageContainer maxWidth='lg'>
      ...
      <Typography variant='body1' paragraph>
        Здесь вы найдете документацию по API К-Коннект с примерами запросов и
        ответов. API позволяет взаимодействовать с системой программно для
        ...
        <>
          ...
          >
            ...
            <Typography variant='body2' paragraph>
              API К-Коннект защищено от несанкционированного доступа с помощью
              CORS и механизма проверки API-ключей. Для использования API из
              внешних приложений или скриптов необходимо получить API-ключ.
            </Typography>

            <SectionTitle variant='subtitle2'>Ограничения CORS</SectionTitle>
            <Typography variant='body2' paragraph>
              По умолчанию API доступно только для запросов с домена
              k-connect.ru и локальных разработочных сред. Для доступа из
              внешних приложений используйте API-ключ.
            </Typography>
            ...
            <Typography variant='body2' paragraph>
              Для обхода ограничений CORS и получения доступа к API из любого
              приложения, необходимо добавить специальный заголовок{' '}
              <code>X-API-Key</code> ко всем запросам.
            </Typography>
...
.catch(error => console.error('Ошибка:', error));`}
            ...
            <Typography variant='body2' paragraph>
              API-ключ можно получить у администрации К-Коннект. Для получения
              ключа необходимо:
            </Typography>
            <ol>
              <li>Быть зарегистрированным пользователем К-Коннект</li>
              <li>
                Отправить запрос администрации с описанием цели использования
                API
              </li>
              <li>
            ...
            >
              <b>Важно:</b> Храните ваш API-ключ в безопасности и не передавайте
              его третьим лицам. Ключ может быть отозван в случае нарушения
          ...
          >
            ...
            <Typography variant='body2' paragraph>
              К-Коннект поддерживает несколько способов авторизации для
            ...
            <Typography variant='body2' paragraph>
              Используйте session_key из LocalStorage для авторизации. Это
              наиболее безопасный и удобный способ для веб-приложений.
            </Typography>
            <CodeBlock>
...
document.cookie = \`session_key=\${sessionKey}; path=/\`;`}
            ...
            <Typography variant='body2' paragraph>
              Классическая авторизация с логином и паролем. Поддерживает
              remember me функциональность.
            </Typography>

            <SectionTitle variant='subtitle2'>3. Telegram</SectionTitle>
            <Typography variant='body2' paragraph>
              Авторизация через Telegram Bot API. Пользователь авторизуется
              через Telegram и получает доступ к системе.
            </Typography>

            <SectionTitle variant='subtitle2'>4. Element (Matrix)</SectionTitle>
            <Typography variant='body2' paragraph>
              Авторизация через Element клиент. Создает пользователя
            ...
            <ul>
              <li>
                Session Key хранится в LocalStorage и автоматически отправляется
                с запросами
              </li>
...
// Забаненный пользователь:
{
  ...
  "message": "Выход выполнен успешно"
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`POST /api/auth/telegram
Content-Type: application/json
{
  ...
  "sessions": [
    {
      ...
      "is_current": boolean
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`DELETE /api/auth/sessions/{session_id}`}
            response={`{
  "success": true,
...
Content-Type: application/json
{
  ...
  "message": "Пароль успешно изменен"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/auth/setup-credentials
Content-Type: application/json
{
  "email": "string",
  "password": "string"
  ...
  "message": "Учетные данные настроены"
          ...
          >
            <Typography
              variant='h6'
              sx={{ color: theme.palette.warning.main, mb: 2 }}
            >
            ...
            <Typography variant='body2' paragraph>
              ...
              <br />• Пользователи блокируются на 15 минут после 5 неудачных
              попыток входа
            </Typography>
            <Typography variant='body2' paragraph>
              <strong>Валидация:</strong>
              <br />• Username: 3-30 символов, только буквы, цифры,
              подчеркивание
            ...
            <Typography variant='body2'>
              ...
              <br />• Отправляйте в заголовке: Authorization: Bearer
              &lt;session_key&gt;
  ...
  "user": {
    ...
    "telegram_username": "@username"
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/profile/username/stats`}
            response={`{
  "total_likes": 1000,
  "posts_count": 50,
  "days_active": 365,
...
Content-Type: application/json
{
  ...
  "message": "Имя успешно обновлено"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/profile/username
Content-Type: application/json
{
  ...
  "message": "Имя пользователя успешно обновлено"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/profile/about
Content-Type: application/json
{
  ...
  "message": "Описание профиля успешно обновлено"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/profile/avatar
Content-Type: multipart/form-data
{
  ...
  "avatar_url": "/static/uploads/avatar/1/avatar.jpg"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/profile/banner
Content-Type: multipart/form-data
{
  "banner": "file"
}`}
  ...
  "banner_url": "/static/uploads/banner/1/banner.jpg"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/profile/background
Content-Type: multipart/form-data
{
  "background": "file"
}`}
  ...
  "profile_background_url": "/static/uploads/prof_back/1/bg.jpg"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/profile/background/delete`}
            response={`{
  "success": true,
  "message": "Фон успешно удален"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/profile/avatar/delete`}
            response={`{
  "success": true,
  "message": "Аватар успешно удален"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/profile/banner/delete`}
            response={`{
  "success": true,
  "message": "Баннер успешно удален"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/profile/social
Content-Type: application/x-www-form-urlencoded
{
  ...
  "message": "Социальная сеть успешно обновлена"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/profile/social/delete
Content-Type: application/x-www-form-urlencoded
{
  "name": "Telegram"
}`}
  ...
  "message": "Социальная сеть успешно удалена"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/profile/follow/username`}
            response={`{
  "success": true,
  "is_following": true,
  "is_friend": false,
  ...
  "message": "Вы подписались на пользователя"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/profile/unfollow/username`}
            response={`{
  "success": true,
  "is_following": false,
  "is_friend": false,
  ...
  "message": "Вы отписались от пользователя"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/profile/notifications/toggle
Content-Type: application/json
{
  "followed_id": 1
}`}
  ...
  "message": "Уведомления включены"
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/profile/username/posts?page=1&per_page=20&media=photos`}
            response={`{
  "posts": [],
  "page": 1,
  "per_page": 20,
  ...
  "pages": 5
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/profile/username/wall?page=1&per_page=10`}
            response={`{
  "posts": [],
  "page": 1,
  "per_page": 10,
  ...
  "pages": 2
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/profile/username/followers`}
            response={`{
  "followers": [],
  "total": 100,
  "page": 1,
  ...
  "has_prev": false
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/profile/username/following`}
            response={`{
  "following": [],
  "total": 50,
  "page": 1,
  ...
  "has_prev": false
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/profile/username/friends`}
            response={`{
  "friends": [],
  "total": 25,
  "page": 1,
  ...
  "has_prev": false
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/profile/username/media?media_type=photo&page=1&per_page=20`}
            response={`{
  "media": [],
  "has_next": false,
  "total": 50,
  ...
  "pages": 1
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/profile/username/attachments?media_type=photo&page=1&per_page=20`}
            response={`{
  "attachments": [],
  "has_next": false,
  "total": 30,
  ...
  "pages": 1
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/profile/username/photos?page=1&per_page=20`}
            response={`{
  "media": [],
  "has_next": false,
  "total": 30,
  ...
  "pages": 1
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/profile/username/videos?page=1&per_page=20`}
            response={`{
  "media": [],
  "has_next": false,
  "total": 20,
  ...
  "pages": 1
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/profile/username/pinned`}
            response={`{
  "id": 1,
  "content": "Текст поста",
  ...
  "is_owner": false
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/profile/pin/123`}
            response={`{
  "message": "Post pinned successfully"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/profile/unpin`}
            response={`{
  "message": "Post unpinned successfully"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/profile/status/v2
Content-Type: application/json
{
  ...
  "status": {
    ...
    "color": "#ff0000"
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/profile/username/medals`}
            response={`{
  "success": true,
  "medals": [
    {
  ...
  "total": 20
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/medals/gold/users`}
            response={`{
  "success": true,
  "medal_name": "gold",
  "image_path": "/static/medals/gold.svg",
  ...
  "total": 10
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`GET /api/profile/username/friendship/status`}
            response={`{
  "success": true,
  "is_self": false,
  "is_following": true,
  ...
  "achievements": [
    {
      ...
      "color_upgrade": "#ffd700"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/achievements/activate
Content-Type: application/json
{
  "achievement_id": 1
}`}
  ...
  "achievement": {
    ...
    "profile_name": "ACTIVE"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/achievements/clear`}
            response={`{
  "success": true,
  "message": "Активный бейдж удален"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`GET /api/element/status`}
            response={`{
  "success": true,
  "connected": true,
  "elem_id": "element_id"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/telegram/connect
Content-Type: application/json
{
  "telegram_id": "123456789"
}`}
  ...
  "telegram_notifications_enabled": true
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/telegram/disconnect`}
            response={`{
  "success": true,
      ...
      {activeTab === 2 && (
        <>
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/posts?page=1&per_page=20&media=photos&sort=newest`}
            response={`{
  "posts": [
    {
      "id": 456,
  ...
  "has_prev": false
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`GET /api/posts/feed?page=1&per_page=20&media=all`}
            response={`{
  "posts": [
    {
      "id": 457,
  ...
  "has_prev": false
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/posts/456?include_comments=true`}
            response={`{
  "post": {
    "id": 456,
    "text": "Пример текста поста",
...
Content-Type: application/json
{
  ...
  "dislikes_count": 2
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/posts/456/likes?page=1&per_page=20`}
            response={`{
  "likes": [
    {
      "id": 125,
  ...
  "has_prev": false
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/posts/456/repost
Content-Type: application/json
{
  ...
  "repost": {
    ...
    "comments": []
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`DELETE /api/reposts/459`}
            response={`{
  "success": true,
  "message": "Репост успешно удален"
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`POST /api/posts/456/view`}
            response={`{
  "success": true,
  "views_count": 151
}`}
  ...
  "fact": {
    ...
    "attached_to_post": null
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/posts/456/facts/attach
Content-Type: application/json
{
  "fact_id": 1
}`}
  ...
  "message": "Факт прикреплен к посту"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/posts/456/facts/detach`}
            response={`{
  "success": true,
  "message": "Факт откреплен от поста"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`GET /api/facts?page=1&per_page=20`}
            response={`{
  "facts": [
    {
      "id": 1,
...
Content-Type: application/json
{
      ...
      {activeTab === 3 && (
        <>
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/posts/456/comments?page=1&per_page=20`}
            response={`{
  "comments": [
    {
      "id": 789,
  ...
  "pages": 1
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/posts/456/comments
Content-Type: application/json
{
  ...
  "comment": {
    ...
    "is_liked": false
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`DELETE /api/comments/790`}
            response={`{
  "success": true,
  "message": "Комментарий успешно удален"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/comments/789/like`}
            response={`{
  "success": true,
  "is_liked": true,
  "likes_count": 3
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/comments/789/unlike`}
            response={`{
  "success": true,
  "is_liked": false,
  "likes_count": 2
      ...
      {activeTab === 4 && (
        <>
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`GET /api/notifications?page=1&per_page=20`}
            response={`{
  "notifications": [
    {
      "id": 321,
  ...
  "unread_count": 0
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/notifications/321/read`}
            response={`{
  "success": true,
...
Content-Type: application/json
{
  ...
  "message": "Подписка на push-уведомления успешно создана"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`DELETE /api/push/unsubscribe
Content-Type: application/json
{
  "endpoint": "https:
}`}
...
Content-Type: application/json
{
      ...
      {activeTab === 5 && (
        <>
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/leaderboard?period=week&limit=20`}
            response={`{
  "success": true,
  "leaderboard": [
    {
  ...
  "snapshot_generated_at": "2024-01-07T20:00:00Z"
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/leaderboard/user/123?period=week`}
            response={`{
  "success": true,
  "user": {
    "id": 123,
    ...
    "end": "2024-01-07T23:59:59Z"
          ...
          >
            ...
            <Box component='ul' sx={{ pl: 2 }}>
              <li>
                <strong>Создание поста:</strong> 5 очков
              </li>
              <li>
                <strong>Лайк на посте:</strong> 1 очко
              </li>
              <li>
                <strong>Создание комментария:</strong> 5 очков
              </li>
              <li>
                <strong>Лайк на комментарии:</strong> 1 очко
              </li>
              <li>
                <strong>Создание ответа:</strong> 3 очка
              </li>
              <li>
                <strong>Лайк на ответе:</strong> 1 очко
              </li>
              <li>
                <strong>Репост:</strong> 4 очка
              </li>
              <li>
                <strong>Создание истории:</strong> 2 очка
              </li>
              <li>
                <strong>Просмотр истории:</strong> 1 очко
              </li>
              <li>
                <strong>Реакция на историю:</strong> 2 очка
              </li>
            </Box>
            <Typography variant='body2' sx={{ mt: 2, fontStyle: 'italic' }}>
              <strong>Примечание:</strong> Активность каналов не учитывается в
              лидерборде. Периоды: неделя (с воскресенья 19:00 МСК), месяц, все
              время.
            </Typography>
          </Box>
        </>
          ...
          >
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
              ...
              <Typography variant='h6'>
                Специальный ключ для загрузки музыки
              </Typography>
            </Box>
            <Typography variant='body2' paragraph>
              Для загрузки треков и текстов песен используется отдельный ключ
              доступа. В отличие от общего API-ключа, музыкальный ключ работает
              только с эндпоинтами загрузки музыки.
            </Typography>

            <SectionTitle variant='subtitle2'>
              Использование X-Key для загрузки треков
            </SectionTitle>
            <Typography variant='body2' paragraph>
              При загрузке треков (/api/music/upload) или текстов песен
              (/api/music/&lt;track_id&gt;/lyrics/upload), необходимо добавить
              заголовок <code>X-Key</code> с соответствующим ключом, полученным
              у администрации.
            </Typography>
...
.catch(error => console.error('Ошибка:', error));`}
            ...
            >
              <b>Примечание:</b> Музыкальный ключ (X-Key) работает <i>только</i>{' '}
              с эндпоинтами загрузки. Для других операций с музыкой используйте
              стандартный API-ключ (X-API-Key).
            </Typography>
          </Box>
  ...
  "current_page": 1
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/music/user/456?page=1&per_page=20`}
            response={`{
  "success": true,
  "tracks": [
    {
  ...
  "track": {
    ...
    "is_liked": false
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`POST /api/music/metadata
Content-Type: multipart/form-data
...
file: [аудиофайл]`}
  ...
  "tracks": [
    {
      ...
      "is_liked": false
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`GET /api/music/liked?page=1&per_page=20`}
            response={`{
  "success": true,
  "tracks": [
    {
  ...
  "current_page": 1
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/music/random?exclude_id=123`}
            response={`{
  "success": true,
  "track": {
    "id": 124,
    ...
    "is_liked": false
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/music/next?current_id=123&context=liked`}
            response={`{
  "success": true,
  "track": {
    "id": 124,
    ...
    "is_liked": true
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/music/previous?current_id=123&context=liked`}
            response={`{
  "success": true,
  "track": {
    "id": 122,
    ...
    "is_liked": true
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`GET /api/music/search?query=запрос`}
            response={`[
  {
    "id": 123,
  ...
  "plays_count": 44
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/music/tracks?type=all&offset=0&limit=10&sort=newest`}
            response={`{
  "success": true,
  "tracks": [
    {
  ...
  "has_more": true
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/music/charts?type=combined&limit=20`}
            response={`{
  "success": true,
  "charts": {
    "most_played": [
    ...
    "new_releases": [
      {
        ...
        "likes_count": 10
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/music/artist?id=1&page=1&per_page=20`}
            response={`{
  "success": true,
  "artist": {
    "id": 1,
    ...
    "current_page": 1
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/music/123/lyrics`}
            response={`{
  "track_id": 123,
  "has_lyrics": true,
...
// Или JSON данные
{
  ...
  "message": "Для вас подобраны популярные и случайные треки. Лайкайте то, что нравится, чтобы улучшить рекомендации!"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`GET /api/music/playlists`}
            response={`{
  "success": true,
  "playlists": [
    {
      ...
      "updated_at": "2023-06-15T15:30:45"
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/music/playlists/1`}
            response={`{
  "success": true,
  "playlist": {
    "id": 1,
    ...
    "is_owner": true
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/music/playlists
Content-Type: multipart/form-data
  ...
  "playlist": {
    ...
    "updated_at": "2023-06-15T16:30:45"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`PUT /api/music/playlists/1
Content-Type: multipart/form-data
...
cover: [новое изображение]`}
  ...
  "playlist": {
    ...
    "updated_at": "2023-06-15T17:30:45"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`DELETE /api/music/playlists/1`}
            response={`{
  "success": true,
  "message": "Плейлист удален"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/music/playlists/1/tracks
Content-Type: application/json

{
  ...
  "added_count": 3
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`DELETE /api/music/playlists/1/tracks/123`}
            response={`{
  "success": true,
  "message": "Трек удален из плейлиста"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/music/playlists/1/tracks/reorder
Content-Type: application/json

{
  ...
  "message": "Порядок треков изменен"
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/music/playlists/public?page=1&per_page=10`}
            response={`{
  "success": true,
  "playlists": [
    {
  ...
  "current_page": 1
          ...
          <ApiEndpoint
            ...
            authRequired={false}
            request={`GET /api/music/playlists/user/456`}
            response={`{
  "success": true,
  "playlists": [
    {
  ...
  "user": {
    ...
    "avatar_url": "/static/uploads/avatar/456/avatar.png"
          ...
          <ApiEndpoint
            ...
            authRequired={true}
            request={`POST /api/music/123/verify
Content-Type: application/json

{
  ...
  "is_verified": true
      ...
      {activeTab === 8 && (
        <>
          ...
          <Typography variant='body2' paragraph>
            API для системы магазина бейджиков, включающей создание, покупку,
            управление роялти и отслеживание трендов. Система поддерживает
            ограничения по подпискам и защиту от дублирования покупок.
          </Typography>

          <SectionTitle variant='h6'>Просмотр магазина</SectionTitle>
          <ApiEndpoint
            method='GET'
  ...
  "badges": [
    {
      ...
      "color_upgrade": "#FFD700"
          ...
          <SectionTitle variant='h6'>Управление баллами</SectionTitle>
          <ApiEndpoint
            method='GET'
  ...
  "points": 15000
          ...
          <SectionTitle variant='h6'>Покупка бейджиков</SectionTitle>
          <ApiEndpoint
            method='POST'
  ...
  "pagination": {
    ...
    "has_more": true
          ...
          <SectionTitle variant='h6'>Создание бейджиков</SectionTitle>
          <ApiEndpoint
            method='POST'
  ...
  "badges": [
    {
      ...
      "royalties_earned": 2250
          ...
          <SectionTitle variant='h6'>Роялти и доходы</SectionTitle>
          <ApiEndpoint
            method='GET'
    ...
    "has_more": false
      ...
      {activeTab === 9 && (
        <>
          ...
          <Typography variant='body2' paragraph>
            API для системы отслеживания багов, позволяющее пользователям
...
Content-Type: application/json
{
  ...
  "status": "В работе"
      ...
      {activeTab === 10 && (
        <>
          ...
          <Typography variant='body2' paragraph>
            API для работы с системой инвентаря, паками-сундуками и предметами.
            Позволяет покупать паки, открывать их, управлять предметами и
            торговать на маркетплейсе.
          </Typography>

          <SectionTitle variant='h6'>Паки и покупки</SectionTitle>
          <ApiEndpoint
            method='GET'
  ...
  "purchases": [
    {
      ...
      "is_opened": true
          ...
          <SectionTitle variant='h6'>Управление инвентарем</SectionTitle>
          <ApiEndpoint
            method='GET'
  ...
  "pagination": {
    ...
    "has_prev": false
          ...
          <SectionTitle variant='h6'>Управление предметами</SectionTitle>
          <ApiEndpoint
            method='POST'
...
Content-Type: application/json
{
  ...
  "remaining_points": 105
          ...
          <SectionTitle variant='h6'>Информация о предметах</SectionTitle>
          <ApiEndpoint
            method='GET'
  ...
  "images": [
    ...
    },
    {
      ...
      "exists": true
          ...
          <SectionTitle variant='h6'>Маркетплейс</SectionTitle>
          <ApiEndpoint
            method='POST'
  ...
  "listings": [
    {
      ...
      "item": {
        ...
        "item_number": 1
          ...
          <SectionTitle variant='h6'>Поиск получателей</SectionTitle>
          <ApiEndpoint
            method='GET'
