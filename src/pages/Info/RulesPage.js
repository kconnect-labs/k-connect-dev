            ...
            >
              ...
              <Box>
                ...
                >
                  ...
                  придерживайтесь следующих правил. Их нарушение может привести
                  к ограничениям доступа или другим санкциям.
                </Typography>
              </Box>
            </Box>
          </motion.div>
                  ...
                  <NumberedRuleItem>
                    ...
                    <Box>
                      ...
                      <Typography variant='body2' color='text.secondary'>
                        ...
                        дискриминации, угроз или травли. Конструктивная критика
                        и дискуссии приветствуются, но должны оставаться в
                        рамках уважительного общения.
                      </Typography>
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                        ...
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Запрещено целенаправленное преследование
                            пользователей (сталкинг), массовые оскорбления,
                        ...
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Запрещены угрозы физической расправы, насилия,
                            смерти, причинения вреда здоровью или имуществу.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                    ...
                    <Box>
                      ...
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Запрещены призывы к насилию, экстремизму,
                            терроризму, свержению власти, массовым беспорядкам.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                  ...
                  <NumberedRuleItem>
                    ...
                    <Box>
                      ...
                      <Typography variant='body2' color='text.secondary'>
                        ...
                        их согласия (доксинг), угрозы или принуждения к
                        действиям.
                      </Typography>
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Запрещено публиковать персональные данные: ФИО,
                            номера телефонов, адреса, паспортные данные, ИНН,
                            СНИЛС, медицинские данные.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          <SubRuleNumber>1.3.2</SubRuleNumber>
                          <Typography variant='body2'>
                            Запрещено публиковать интимные фото/видео без
                            согласия участников (revenge porn, сливы).
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          <SubRuleNumber>1.3.3</SubRuleNumber>
                          <Typography variant='body2'>
                            Запрещены угрозы физической расправы, нанесения
                            ущерба имуществу, репутации, семье.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                    ...
                    <Box>
                      ...
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            При публикации чужого контента обязательно
                            указывайте автора, источник, ссылку на оригинал.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                        ...
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Запрещено использование товарных знаков, логотипов
                    ...
                    <Box>
                      ...
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Реалистичные сцены насилия, жестокости, инструкции
                            по причинению вреда себе или другим.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                        ...
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Инструкции по изготовлению оружия, взрывчатых
                            веществ или других опасных предметов.
                          </Typography>
                        </SubRuleItem>
                      </Box>
                    </Box>
                      ...
                      <Box sx={{ mt: 1 }}>
                        ...
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            ...
                            гениталии, анальный секс, оральный секс,
                            мастурбация.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                    ...
                    <Box>
                      ...
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Фишинговые ссылки, финансовые пирамиды, обманные
                            схемы заработка.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                      ...
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            ...
                            заблуждение (например, о выборах, здоровье,
                            стихийных бедствиях).
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                    ...
                    <Box>
                      ...
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Эротика: полуобнаженные тела, эротические позы, но
                            без откровенных гениталий.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            ...
                            искусстве, фотографии, но без сексуального
                            контекста.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Сексуализированный контент: откровенные наряды,
                            позы, но без половых актов или гениталий.
                          </Typography>
                        </SubRuleItem>
                      </Box>
                    </Box>
                    ...
                    <Box>
                      ...
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Откровенные гениталии (половые органы, анус) - даже
                            в NSFW постах.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          ...
                          <Box sx={{ mt: 1 }}>
                            ...
                            <SubRuleItem>
                              ...
                              <Typography variant='body2'>
                                ...
                                минимального возраста, аккаунт будет
                                заблокирован до достижения пользователем
                        ...
                        <Box>
                          ...
                          <Box sx={{ mt: 1 }}>
                            ...
                            <SubRuleItem>
                              ...
                              <Typography variant='body2'>
                                Запрещено использовать чужие фотографии в
                                качестве аватара без разрешения.
                              </Typography>
                            </SubRuleItem>
                            <SubRuleItem>
                              <SubRuleNumber>4.2.3</SubRuleNumber>
                              <Typography variant='body2'>
                                Запрещено создание аккаунтов для подмены
                                личности и введения других пользователей в
                                заблуждение.
                              </Typography>
                            </SubRuleItem>
                          </Box>
                        ...
                        <Box>
                          ...
                          <Box sx={{ mt: 1 }}>
                            <SubRuleItem>
                              ...
                              <Typography variant='body2'>
                                Запрещено использовать дополнительные аккаунты
                                для обхода блокировок или ограничений.
                              </Typography>
                            </SubRuleItem>
                            <SubRuleItem>
                ...
                <RuleCardContent>
                    ...
                    <Box>
                      ...
                      <Box sx={{ mt: 1 }}>
                        ...
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Повторное нарушение: временная блокировка аккаунта
                            на срок от 24 часов до 30 дней в зависимости от
                            тяжести нарушения.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                      ...
                      <Box sx={{ mt: 1 }}>
                        ...
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            ...
                            корректировать баланс пользователя в случае
                            технических сбоев или нарушений.
                          </Typography>
                        </SubRuleItem>
                      </Box>
                    </Box>
                  ...
                  <NumberedRuleItem>
                    ...
                    <Box>
                      ...
                      <Typography variant='body2' color='text.secondary'>
                        Если вы не согласны с удалением контента или
                        блокировкой, напишите в поддержку в течение 7 дней.
                      </Typography>
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                ...
                <RuleCardContent>
                      ...
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            ...
                            используйте функцию "Пожаловаться" для
                            информирования модерации.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                  ...
                  <NumberedRuleItem>
                    ...
                    <Box>
                      ...
                      <Typography variant='body2' color='text.secondary'>
                        Вы несёте ответственность за безопасность своего
                        аккаунта и его доступность.
                      </Typography>
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                ...
                <RuleCardContent>
                  ...
                  <NumberedRuleItem>
                    ...
                    <Box>
                      ...
                      <Typography variant='body2' color='text.secondary'>
                        Все бейджики должны быть оригинальными работами.
                        Запрещено копирование, имитация или незначительная
                        модификация существующих бейджиков.
                      </Typography>
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                    ...
                    <Box>
                      ...
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Используйте только форматы SVG для создания
                            бейджиков для обеспечения высокого качества при
                            любом размере отображения.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                      ...
                      <Box sx={{ mt: 1 }}>
                        ...
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            ...
                            собственности третьих лиц, включая логотипы и
                            товарные знаки без должной авторизации.
                          </Typography>
                        </SubRuleItem>
                      </Box>
                    </Box>
          ...
          <motion.div variants={itemVariants}>
            <RuleSection>
              <RuleCard>
                ...
                <RuleCardContent>
                  <Typography variant='body1' paragraph>
                    Пачки Айтемов в К-Коннект — это коллекции уникальных
                    элементов для персонализации профиля. Для обеспечения
                    качества и соответствия стандартам платформы, все пачки
                    проходят строгую модерацию.
                  </Typography>
                  ...
                  <NumberedRuleItem>
                    ...
                    <Box>
                      ...
                      <Typography variant='body2' color='text.secondary'>
                        Все файлы в пачке должны соответствовать строгим
                        техническим стандартам для обеспечения качества и
                        производительности.
                      </Typography>
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Файлы должны иметь соотношение сторон 1:1
                            (квадратная форма).
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Размер одного файла не должен превышать 150-200
                            килобайт.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Файлы не должны содержать фоновые элементы,
                            свечение, тени или другие эффекты.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          <SubRuleNumber>8.1.4</SubRuleNumber>
                          <Typography variant='body2'>
                            Изображения должны быть идеально ровными, без
                            плохого вырезания, зазубрин или неровных краев.
                          </Typography>
                        </SubRuleItem>
                      </Box>
                    </Box>
                  ...
                  <NumberedRuleItem>
                    ...
                    <Box>
                      ...
                      <Typography variant='body2' color='text.secondary'>
                        Все айтемы в пачке должны быть уникальными авторскими
                        работами, не похожими на существующие.
                      </Typography>
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                          <SubRuleNumber>8.2.1</SubRuleNumber>
                          <Typography variant='body2'>
                            Запрещено копирование или незначительная модификация
                            существующих айтемов.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          <SubRuleNumber>8.2.2</SubRuleNumber>
                          <Typography variant='body2'>
                            Не приветствуется "слизывание" дизайна или концепций
                            других авторов.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Предложение айтемов из других площадок или платформ
                            может привести к предупреждению.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          <SubRuleNumber>8.2.4</SubRuleNumber>
                          <Typography variant='body2'>
                            Каждый айтем должен иметь уникальную концепцию и
                            дизайн.
                          </Typography>
                        </SubRuleItem>
                      </Box>
                  ...
                  <NumberedRuleItem>
                    ...
                    <Box>
                      ...
                      <Typography variant='body2' color='text.secondary'>
                        Пачки не должны содержать контент, нарушающий общие
                        правила платформы.
                      </Typography>
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Запрещен контент 18+: порнография, откровенные
                            изображения, сексуальные сцены.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          <SubRuleNumber>8.3.2</SubRuleNumber>
                          <Typography variant='body2'>
                            Запрещены изображения насилия, крови, оружия,
                            наркотиков, алкоголя.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Запрещены оскорбительные, дискриминационные или
                        ...
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Запрещены политические символы, логотипы брендов без
                            разрешения, религиозные символы в оскорбительном
                            контексте.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Запрещены изображения, нарушающие авторские права
                            третьих лиц.
                          </Typography>
                        </SubRuleItem>
                      </Box>
                  ...
                  <NumberedRuleItem>
                    ...
                    <Box>
                      ...
                      <Typography variant='body2' color='text.secondary'>
                        Пачки должны соответствовать общему стилю платформы и
                        быть приятными для восприятия.
                      </Typography>
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                          <SubRuleNumber>8.4.1</SubRuleNumber>
                          <Typography variant='body2'>
                            Рекомендуется использовать яркие, контрастные цвета
                        ...
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Избегайте слишком сложных деталей, которые могут
                            плохо смотреться в маленьком размере.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          <SubRuleNumber>8.4.3</SubRuleNumber>
                          <Typography variant='body2'>
                            Айтемы должны быть понятными и легко читаемыми даже
                            в уменьшенном виде.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Рекомендуется использовать простые, четкие формы и
                    ...
                    <Box>
                      ...
                      <Box sx={{ mt: 1 }}>
                        ...
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Администрация оставляет за собой право отклонять
                            пачки, не соответствующие стандартам качества или
                            нарушающие правила платформы.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            В случае обнаружения нарушений после публикации,
                            пачка может быть удалена без предупреждения.
                          </Typography>
                        </SubRuleItem>
                      </Box>
                    </Box>
                ...
                <RuleCardContent>
                    ...
                    <Box>
                      ...
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                          <SubRuleNumber>8.1.1</SubRuleNumber>
                          <Typography variant='body2'>
                            Запрещены материалы, демонстрирующие реальное
                            насилие, издевательства, травмы и раны.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          <SubRuleNumber>8.1.2</SubRuleNumber>
                  ...
                  <NumberedRuleItem>
                    ...
                    <Box>
                      ...
                      <Typography variant='body2' color='text.secondary'>
                        Контент, который может вызвать сильную негативную
                        реакцию или психологический дискомфорт у пользователей
                      ...
                      <Box sx={{ mt: 1 }}>
                        ...
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            ...
                            психологические расстройства или паническое
                            состояние.
                          </Typography>
                        </SubRuleItem>
                      </Box>
                      ...
                      <Box sx={{ mt: 1 }}>
                        ...
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            ...
                            ненависть по признаку расы, национальности, религии
                            и т.д.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
          ...
          <motion.div variants={itemVariants}>
            <RuleSection>
              <RuleCard>
                ...
                <RuleCardContent>
                  <Typography variant='body1' paragraph>
                    Приватные профили имеют особые правила модерации,
                    учитывающие их закрытый характер. Однако это не означает
                    полную свободу от правил платформы.
                  </Typography>
                  ...
                  <NumberedRuleItem>
                    ...
                    <Box>
                      ...
                      <Typography variant='body2' color='text.secondary'>
                        Приватные профили проходят менее строгую модерацию, так
                        как контент виден только взаимным друзьям. Однако
                        основные правила платформы остаются обязательными.
                      </Typography>
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                          <SubRuleNumber>9.1.1</SubRuleNumber>
                          <Typography variant='body2'>
                            Контент в приватных профилях не проходит
                            предварительную модерацию, но может быть проверен по
                            жалобам.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            При получении жалоб на контент приватного профиля,
                            модерация проводит проверку и принимает решение о
                        ...
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Нарушения в приватных профилях наказываются так же,
                            как и в публичных - предупреждения, временные
                            блокировки, постоянные блокировки.
                          </Typography>
                        </SubRuleItem>
                      </Box>
                    </Box>
                  ...
                  <NumberedRuleItem>
                    ...
                    <Box>
                      ...
                      <Typography variant='body2' color='text.secondary'>
                        В приватных профилях разрешена публикация контента 18+
                        без обязательной маркировки NSFW, но с соблюдением
                        ограничений.
                      </Typography>
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                        ...
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Разрешена порнография: без сексуального насилия, без
                            сексуального насилия над животными.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                        ...
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Запрещена детская порнография, педофилия,
                            сексуализация несовершеннолетних, зоофильство.
                          </Typography>
                        </SubRuleItem>
                      </Box>
                    </Box>
                  ...
                  <NumberedRuleItem>
                    ...
                    <Box>
                      ...
                      <Typography variant='body2' color='text.secondary'>
                        Даже в приватных профилях запрещен контент, который
                        может нанести вред или нарушить закон.
                      </Typography>
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                        ...
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Запрещено распространение личных данных других людей
                            без их согласия (доксинг).
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                  ...
                  <NumberedRuleItem>
                    ...
                    <Box>
                      ...
                      <Typography variant='body2' color='text.secondary'>
                        Владельцы приватных профилей несут полную
                        ответственность за публикуемый контент, даже если он
                        виден ограниченному кругу лиц.
                      </Typography>
                      <Box sx={{ mt: 1 }}>
                        <SubRuleItem>
                          <SubRuleNumber>9.4.1</SubRuleNumber>
                          <Typography variant='body2'>
                            Приватность профиля не является оправданием для
                        ...
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            Владелец профиля отвечает за весь контент, включая
                            комментарии и взаимодействия с другими
                            пользователями.
                          </Typography>
                        </SubRuleItem>
                        <SubRuleItem>
                          ...
                          <Typography variant='body2'>
                            При систематических нарушениях приватный профиль
                            может быть переведен в публичный режим или
                            заблокирован.
                          </Typography>
                        </SubRuleItem>
                      </Box>
              ...
              <RuleCard>
                ...
                <RuleCardContent>
                  ...
                  >
                    ...
                    <Typography variant='body2' color='text.secondary'>
                      Администрация и модерация К-Коннект оставляют за собой
                      право удалять любой контент, комментарии, посты,
                      изображения или видео без предварительного уведомления и
                      объяснения причин, если они считают, что контент нарушает
                      правила платформы или может нанести вред сообществу.
                    </Typography>
                  </Box>
