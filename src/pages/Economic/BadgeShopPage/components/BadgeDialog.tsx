...
export const BadgeDialog: React.FC<BadgeDialogProps> = ({
  ...
  const isSoldOut = badge.max_copies && badge.copies_sold && badge.copies_sold >= badge.max_copies;
  const isPurchased = badge.purchases?.some(purchase => purchase.buyer_id === userId);
        ...
        <Box sx={{ 
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <Box sx={{ 
              ...
              <Typography variant="body1" sx={{ fontWeight: 'bold', color: canBuy ? 'success.main' : 'error.main' }}>
                {userPoints} баллов
              </Typography>
            </Box>
          </Box>
